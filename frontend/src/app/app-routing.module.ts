...
import { RoadmapGraphComponent } from './core/components/pages/roadmap-graph/roadmap-graph.component';
...
const routes: Routes = [
  ...
  getRoute(environment.paths.skillspath,environment.paths.skills,SkillsComponent,null),
  getRoute(environment.paths.roadmapspath,environment.paths.roadmaps,RoadmapsComponent,null),
  getRoute(environment.paths.roadmapsgraphpath,environment.paths.roadmapgraph,RoadmapGraphComponent,null),
